...
Identity: same pet in every frame: the existing calm tuxedo cat with black fur, a white muzzle and chest, yellow-green eyes, and white paws; preserve the existing approved atlas identity exactly. Preserve silhouette, face, proportions, markings, palette, material, style, and props.
