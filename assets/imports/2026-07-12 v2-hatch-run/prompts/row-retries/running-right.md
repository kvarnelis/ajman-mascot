...
Use the attached canonical base for identity and the layout guide only for spacing. Same pet in every frame: the existing calm tuxedo cat with black fur, a white muzzle and chest, yellow-green eyes, and white paws; preserve the existing approved atlas identity exactly. Preserve silhouette, face, palette, material, proportions, markings, and props.
