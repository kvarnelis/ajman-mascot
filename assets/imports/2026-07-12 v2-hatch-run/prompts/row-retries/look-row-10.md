Create Codex v2 pet look row 10 for `ajman` as exactly 8 full-body frames in this order: 180, 202.5, 225, 247.5, 270, 292.5, 315, 337.5.
...
CRITICAL REPAIR EVIDENCE: the prior attempt failed because 202.5, 225, and 247.5 visibly pointed toward the viewer's SCREEN-RIGHT. Correct the complete coherent row. For frames 2-8, the cat's nose tip and pupils must remain on the SCREEN-LEFT side of the head center. The 202.5, 225, and 247.5 poses must transition gradually from down into the approved 270 screen-left cardinal without ever turning right. The last three poses must continue from screen-left upward toward 000. Preserve the approved 180 down pose and all identity, scale, paws, and baseline properties that passed.
